...
urlpatterns = [
    ...
    path('channel-manager/streams/', channel_manager_views.channel_manager_streams, name='channel_manager_streams'),
    path('channel-manager/channels/', channel_manager_views.channel_manager_channels, name='channel_manager_channels'),
